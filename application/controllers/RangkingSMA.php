...
class RangkingSMA extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->page->setTitle('Rangking SMA');
        /**
         * Menghapus table SAW
         */
        $this->MSAW->dropTable();
        ...
        $this->load->view('saw/dashboardsma', $data);
    }
    ...
    {
        $this->page->setTitle('Nilai Awal Sekolah Menengah Atas');
    ...
    {
        $nilai = $this->MNilaiSma->getNilaiSekolah();
    ...
    {
        $config['base_url'] = 'http://localhost/spksekolah/RangkingSMA/nilairangking';
