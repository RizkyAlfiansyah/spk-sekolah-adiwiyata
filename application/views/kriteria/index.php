          ...
          <div class="form-body">
            ...
            ?>
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input name="itemKriteria<?php echo $no ?>" placeholder="Item Kriteria <?php echo $no ?>" class="form-control" type="text">
                  <input name="kdSubKriteria<?php echo $no ?>" type="hidden">
                </div>
                <div class="col-sm-2">
                  <label class="control-label col-md-4">Value</label>
                  <div class="col-md-6">
                    <input name="value<?php echo $no ?>" placeholder="" class="form-control" type="text" disabled>
                  </div>
                </div>
              </div>
            <?php }
