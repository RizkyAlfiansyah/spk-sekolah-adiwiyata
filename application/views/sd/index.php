            ...
            <table class="table table-hover">
              <thead>
                <tr>
                  ...
                  <th class="col-md-4">Sekolah Dasar</th>
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary btn-xs" href="<?php echo site_url('SekolahDasar/tambah/' . $item->kdSekolah) ?>" role="button">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Ubah
                        </a>

                        <a class="btn btn-danger btn-xs" href="<?php echo site_url("SekolahDasar/delete/" . $item->kdSekolah); ?>" onclick="return confirm('Hapus data?');">
                          <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Hapus
                        </a>

                        <!-- Contextual button for informational alert messages -->
                        <button type="button" class="btn btn-info btn-xs" onclick="lihat_nilai(<?php echo $item->kdSekolah; ?>)">
