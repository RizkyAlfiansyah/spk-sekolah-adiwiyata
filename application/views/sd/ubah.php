<div class="page-header">
  <h1>Ubah Data <?php echo $this->page->generateTitle(); ?></h1>
</div>
<div class="col-md-12">
  <?php echo form_open() ?>
  <div class="row">
          ...
          <div class="form-inline">
            ...
            <div class="form-group">
              ...
              ?>
                  ...
                  <input name="alamat" type="text" class="form-control" id="alamat" value="<?php echo $item->alamat ?>" placeholder="Alamat">
            </div>
    ...
    <div class="pull-right">
      <div class="col-md-12">
        ...
        <a class="btn btn-danger" href="<?php echo site_url('SekolahDasar/index/') ?>" role="button">Batal</a>
