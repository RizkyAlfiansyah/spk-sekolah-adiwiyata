              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary btn-xs" href="<?php echo site_url('SMA/tambah/' . $item->kdSekolah) ?>" role="button">
                          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Ubah
                        </a>

                        <a class="btn btn-danger btn-xs" href="<?php echo site_url("SMA/delete/" . $item->kdSekolah); ?>" onclick="return confirm('Hapus data?');">
                          <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Hapus
                        </a>

                        <!-- Contextual button for informational alert messages -->
                        <button type="button" class="btn btn-info btn-xs" onclick="lihatnilaisma(<?php echo $item->kdSekolah; ?>)">
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for (var item in data.nilai) {
          ...
          console.log(data.nilai[item].nilaisma);
