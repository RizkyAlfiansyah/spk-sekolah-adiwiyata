...
--
-- Host: localhost:3306
-- Generation Time: Sep 16, 2021 at 07:58 AM
...
(27, 'SD Bune', 'Bune'),
(28, 'sadasdasd', 'asdasdasd'),
(29, 'asfsafsdfds', 'asrfsafsdfsaf'),
(30, 'asfasfasfas', 'asfasfsafsaf'),
(31, 'asdasdsafasfsd', 'asfsadfsdfdsfdsf');
...
(4, 'asdfsdfsdf', 'sdfsdfsdfdsf'),
(5, 'sdfdsgsdg', 'sdgfsdgdsg'),
(6, 'asfsadfasdf', 'sdfdsfdsf'),
(7, 'asfsadfsdfsd', 'sdfdsfsdfdsf'),
(8, 'asfsafsafsa', 'asfasfsafsaf'),
(9, 'asfsdfdgfdgfd', 'fgfdhgfhgfhfg'),
(10, 'dgfdhgfh', 'gfhgfhgfhgfh'),
(11, 'dfhsfghfghf', 'fghgfhgfhgfh'),
(12, 'dfhfdhdh', 'fghfghgfhgfh');
...
(50, 'SMA  BONE', 'BONE'),
(53, 'asfdsafsdaf', 'dsafasdfdsfs'),
(54, 'sdfsdafsdaafsd', 'fdsfsdfsdfasd'),
(55, 'sdfsdfdsafsadf', 'sdfsdfsdf'),
(56, 'sdfsdfdsaf', 'sdfdsfsdfsd'),
(57, 'fgfhfhgfh', 'fghgfhgfhgfh');
...
--
ALTER TABLE `datasd`
  MODIFY `kdSekolah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `datasma`
--
ALTER TABLE `datasma`
  MODIFY `kdSekolah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `datasmp`
--
ALTER TABLE `datasmp`
  MODIFY `kdSekolah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
